...
namespace
{
  ...
  {
    auto exampleModule = us::ModuleRegistry::GetModule("MitkExampleModule2");
...
const std::string QmitkExampleView2::VIEW_ID = "org.mitk.views.exampleview2";

void QmitkExampleView2::CreateQtPartControl(QWidget* parent)
{
  ...
  connect(m_Controls.selectionWidget, &QmitkSingleNodeSelectionWidget::CurrentSelectionChanged, this, &QmitkExampleView2::OnImageChanged);
...
void QmitkExampleView2::SetFocus()
{
  m_Controls.processImageButton->setFocus();
}

void QmitkExampleView2::OnImageChanged(const QmitkSingleNodeSelectionWidget::NodeList&)
{
  this->EnableWidgets(m_Controls.selectionWidget->GetSelectedNode().IsNotNull());
}

void QmitkExampleView2::EnableWidgets(bool enable)
{
  m_Controls.processImageButton->setEnabled(enable);
}

void QmitkExampleView2::ProcessSelectedImage()
{
